-- FINAL MOSQUE SLIDES TABLE SETUP (Simplified Schema)
...
-- Create table with simplified schema (no is_active, created_at, updated_at)
...
-- DONE! All 6 operations should complete successfully.
-- Table recreated with proper RLS policies and simplified schema.
