...
class SettingsUtility(context: Context) {
    ...
    var messageImages: String
        get() = sPreferences.getString(MESSAGE_IMAGES_KEY, null) ?: ""
        set(value) {
            setPreference(MESSAGE_IMAGES_KEY, value)
        }
    ...
    var is24HourFormat: Boolean
        get() = sPreferences.getBoolean(KEY_24_HOUR_FORMAT, false)
        set(value) {
            setPreference(KEY_24_HOUR_FORMAT, value)
        }
    ...
    companion object {
        ...
        private const val MESSAGE_IMAGES_KEY = "message_images"
        private const val MOSQUE_INFO_KEY = "moque_info"
        private const val MOSQUE_TIME_KEY = "mosque_time"

        const val KEY_24_HOUR_FORMAT = "24_hour_format"
